...
class Core {
    ...
    */
    PlayerIsActive(uid) {
        ...
        console.log("player is active testing UID: " + this._current_players[uid] + " --- game in session: " + this._game_in_session);
    ...
    */
    GameInSession() {
        ...
        console.log(this._game_in_session, " is the game in session?")
    ...
    */
    StartTutorial(socket) {
        ...
        if (this._current_players.length >= 8) {
            console.log ("kicking out extra players");
    ...
    */
    Countdown(socket, data) {
        ...
        console.log(this._countdown_duration, " is the time");
    ...
    */
    PlayerReady(player, socket) {
        ...
        if (this._current_player_cap >= 8) {
            ...
            console.log (this._current_player_cap, "too many players");
        ...
        if(this._current_players[player.uid]) {
            ...
            console.log(this._strLastEventId);
        ...
        console.log(this._current_player_cap);
    }
    ...
    */
    PlayerRemove(player) {
        ...
        console.log("core player remove");
